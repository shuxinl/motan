...
public final class StringHelper
{
    ...
    {
        boolean b = true;//20140507 modify by hinlin 修复对" "为false的bug
        if ( str == null )
        {
            b = true;
        }
...
//        {
//            LoggerUtil.error("字符串转换出错", exception);
//        }
//        return source;
//    }
...
//    }
    ...
    public static final String toGb2312(String source)
    {
        ...
        {
            LoggerUtil.error("转换字符串为gb2312编码出错", e);
        }
        return temp;
    }
    ...
    public static final String toGBK(String source)
    {
        ...
        {
            LoggerUtil.error("Convert code Error", e);
        }
        return temp;
    }
    ...
    public static int strTrim(String source, int defaultValue)
    {
        ...
        {
            LoggerUtil.error("数字转换出错，请检查数据来源。返回默认值", ex);
            return defaultValue;
        }
    }
    ...
    public static String strTrim(String source, String defaultValue)
    {
        ...
        {
            LoggerUtil.error("这个地方永远也不可能出错啊，这代码。。。。", ex);
            return defaultValue;
        }
    }
    ...
    public static String currencyShortFor(String original)
    {
        ...
        else
        {
            ...
            {
                LoggerUtil.error("字符串[" + original + "]转换成数字出错", e);
            }
